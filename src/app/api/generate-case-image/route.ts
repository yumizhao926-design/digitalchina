...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompts: Record<string, string> = {
      government: 'A professional government document review scene, soft light gray and white background, elegant minimalist design with plenty of white space on the left, abstract representation of AI-powered document analysis positioned on the right side, light and airy color palette dominated by soft grays and whites, a small red cube (rgb(215, 0, 29)) as a subtle accent element on the left side, absolutely no text, no words, no characters, no letters, no logos, no brands, clean and professional atmosphere, modern business style, 2K resolution',
      manufacturing: 'A clean minimalist image with a sleek car positioned exclusively on the right third of the frame, the left two-thirds must be completely empty white space with absolutely nothing, soft light gray and white background, elegant minimalist design, a small red cube (rgb(215, 0, 29)) as a subtle accent element positioned on the far left side, ABSOLUTELY NO TEXT, NO WORDS, NO CHARACTERS, NO LETTERS, NO NUMBERS, NO SYMBOLS, NO LOGOS, NO BRANDS, NO WRITING, NO MARKINGS, completely empty left side, clean and professional atmosphere, modern business style, 2K resolution',
