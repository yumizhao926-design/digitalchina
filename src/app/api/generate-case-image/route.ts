...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompts: Record<string, string> = {
      ...
      manufacturing: 'A modern smart office manufacturing scene with natural flowers as the main element, soft light gray and white background, elegant minimalist design with plenty of white space, abstract representation of intelligent manufacturing operations with beautiful flowers, light and airy color palette dominated by soft pinks and whites, a tiny accent of red (#E60012) as a small geometric detail, absolutely no text, no words, no characters, no letters, no logos, no brands, clean and professional atmosphere, modern business style, 2K resolution',
      healthcare: 'A professional pharmaceutical evidence-based Q&A scene with natural plants and flowers as the main element, soft light gray and white background, elegant minimalist design with plenty of white space, abstract representation of medical data analysis and knowledge retrieval with beautiful plants, light and airy color palette dominated by soft greens and whites, a tiny accent of red (#E60012) as a small geometric detail, absolutely no text, no words, no characters, no letters, no logos, no brands, clean and professional atmosphere, modern business style, 2K resolution',
