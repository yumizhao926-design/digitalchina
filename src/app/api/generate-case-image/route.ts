...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompts: Record<string, string> = {
      ...
      manufacturing: 'A modern smart office manufacturing scene with a sleek car positioned on the right side, soft light gray and white background, elegant minimalist design with plenty of white space on the left, abstract representation of intelligent manufacturing operations, light and airy color palette dominated by soft grays and whites, a small red cube (#E60012) as a subtle accent element on the left side, absolutely no text, no words, no characters, no letters, no logos, no brands, clean and professional atmosphere, modern business style, 2K resolution',
